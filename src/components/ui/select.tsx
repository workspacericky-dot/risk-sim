...
function SelectValue({ className, ...props }: SelectPrimitive.Value.Props) {
  return (
    <SelectPrimitive.Value
      ...
      className={cn("flex-1 min-w-0 overflow-hidden text-ellipsis whitespace-nowrap text-left", className)}
      {...props}
    />
  )
}
  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon
        render={
          <ChevronDownIcon className="pointer-events-none shrink-0 size-4 text-muted-foreground" />
        }
      />
    </SelectPrimitive.Trigger>
  )
