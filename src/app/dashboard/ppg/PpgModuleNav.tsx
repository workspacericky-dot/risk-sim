...
import { BarChart3, BookOpenCheck, ClipboardCheck, DatabaseZap, LayoutDashboard, RefreshCw, Settings2, Target } from 'lucide-react'
...
const items = [
  ...
  { href: '/dashboard/ppg/selera-risiko', label: 'Selera Risiko', icon: Target },
