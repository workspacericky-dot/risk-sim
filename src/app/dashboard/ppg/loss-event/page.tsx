...
import { LossEventControlFields } from './LossEventControlFields'
...
export default async function LossEventPage() {
  ...
  return <div className="space-y-6">
    ...
    {(data.access.isSatker || data.access.isAdmin) ? <LossEventForm>
      ...
      <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
        ...
        <LossEventControlFields registers={data.registers as Record<string, unknown>[]} inputClass={input} />
    ...
    </LossEventForm> : <section className="rounded-2xl border border-cyan-200 bg-cyan-50 p-5 text-sm text-cyan-950"><h3 className="font-bold">Pencatatan dilakukan oleh UPG Satker</h3><p className="mt-1 text-xs leading-relaxed text-cyan-800">UPG Pusat tidak membuat Loss Event atas nama Satker. Gunakan daftar di bawah untuk memeriksa, menghubungkan bukti laporan, dan memvalidasi kejadian yang diajukan.</p></section>}
