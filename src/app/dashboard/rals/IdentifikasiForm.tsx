...
import { Trash2, Plus, Lightbulb, Sparkles, Users2, MessageCircleQuestion, Users, Waypoints, Network, ChevronDown } from 'lucide-react'
...
const TEKNIK_OPTIONS = [
  ...
  { key: 'bowtie', label: 'Bowtie Analysis', desc: 'Rakit diagram ancaman → kejadian → dampak dengan perisai kontrol.', icon: Network },
]
...
export default function IdentifikasiForm({
  ...
  async function handleAdd(e: React.FormEvent) {
    ...
    const sb = createClient()
    // Kode risiko (R-01, R-02, ...) dihasilkan trigger DB, berurutan per sesi (perspektif organisasi).
