      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="text-xl font-bold tracking-tight font-serif flex items-center gap-2">
            <MessageCircleQuestion className="w-5 h-5 text-indigo-500" /> Teknik Structured Interview
          </h2>
          <p className="text-muted-foreground text-xs mt-0.5">Wawancarai narasumber dengan pertanyaan baku, lalu susun jadi risiko.</p>
        </div>
      </div>

      <InterviewFlow sessionId={joined.sessionId} participantId={joined.participantId} />
    </div>
  )
}
