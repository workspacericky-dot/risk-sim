...
export async function GET() {
  ...
  const html = source
    .replace('<nav><a href="#ringkasan">Ringkasan</a><a href="#sla">SLA</a><a href="#data">Data</a><a href="#metode">Metode</a></nav>', '')
    .replace('<nav><a href="#insight">Insight</a><a href="#segmentasi">Segmentasi</a><button class="pill" onclick="window.print()">Cetak laporan</button></nav>', '')
    .replace(/<section class="section" id="metode">[\s\S]*?<\/section>/, '')
