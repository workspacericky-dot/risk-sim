...
export async function GET() {
  ...
  const html = source
    ...
    .replace('Detail angka dasar, formula, interval keyakinan, profil seluruh elemen, indikator komposit, dan outlier tersedia pada dokumen teknis pendamping.', 'Detail definisi, unit analisis, formula penyebut, dan keterbatasan tersedia pada rincian metodologi di bawah ini.')
    .replace('href="analisis_teknis_ketepatan_waktu_SIWAS.md"', 'href="#metode" id="siwas-methodology-toggle" role="button" aria-expanded="false"')
    .replace('Buka metodologi teknis</a>', 'Buka rincian metodologi</a>')
